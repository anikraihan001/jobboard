                                ...
                                <div class="single_jobs white-bg d-flex justify-content-between">
                                    <div class="jobs_left d-flex align-items-center">
                                        ...
                                        <div class="jobs_conetent">
                                            <a href="<?php echo base_url(); ?>job_details/"><h4><?php echo $row->post; ?></h4></a>
                                            <div class="links_locat d-flex align-items-center">
                                                <div class="location">
                                                    <p> <i class="fa fa-map-marker"></i></i><span class="badge badge-secondary"> <?php echo $row->company_addr; ?></span></p>
                                                </div>
                                                <div class="location">
